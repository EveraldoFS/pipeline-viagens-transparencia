-- ============================================================
-- FASE 0: CRIACAO DO BANCO DE DADOS E TABELAS (RAW E SILVER)
-- ============================================================

-- Apaga as tabelas caso ja existam para recriar do zero
...
CREATE TABLE silver_trecho (
    ...
    CONSTRAINT unq_viagem_trecho UNIQUE (id_viagem, sequencia_trecho)
);